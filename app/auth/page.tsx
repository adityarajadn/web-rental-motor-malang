        ...
        <div className="glass-card p-8 rounded-3xl border border-border-color shadow-2xl backdrop-blur-xl">
          ...
          <div className="mt-8">
            <div className="relative flex items-center justify-center mb-6">
              ...
              <div className="relative bg-background px-4 text-xs text-text-muted uppercase tracking-wider font-medium">
                Atau Lanjutkan Dengan
              </div>
            </div>
            
            <div className="grid grid-cols-2 gap-4">
              <button className="flex items-center justify-center gap-2 py-3 border border-border-color hover:bg-surface-hover rounded-xl font-medium transition-colors">
